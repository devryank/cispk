        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <form action="<?= site_url('dashboard/user/edit/proses/' . $user->username); ?>" method="post">
                        <div class="form-group">
                            <label>Full Name</label>
                            <input class="au-input au-input--full" type="text" name="full_name" placeholder="Nama Lengkap">
