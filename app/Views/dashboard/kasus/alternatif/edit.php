        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <?= form_open('dashboard/alternatif/proses-edit/' . $segment[3] . '/' . $alternatif->slug);?>
                        <div class="form-group">
                            <label>Nama Alternatif</label>
                            <input class="au-input au-input--full" type="text" name="nama_alternatif" value="<?= $alternatif->nama_alternatif;?>">
                            <small class="text-danger"><?= \Config\Services::validation()->getError('nama_alternatif'); ?></small>
                        </div>
